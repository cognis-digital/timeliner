...
[![PyPI](https://img.shields.io/pypi/v/cognis-timeliner.svg)](https://pypi.org/project/cognis-timeliner/)
[![CI](https://github.com/cognis-digital/timeliner/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/timeliner/actions)
...
TIMELINER exists for one job — build a forensic super-timeline by merging & normalizing log/artifact csvs — and does it without a SaaS bill or heavyweight setup.
...
```bash
timeliner --version
timeliner scan .                      # scan the current project
timeliner scan . --format json
timeliner scan . --fail-on high       # non-zero exit for CI gates
timeliner mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **plaso/log2timeline**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`timeliner` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
