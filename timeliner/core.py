"""TIMELINER core — Build a forensic super-timeline by merging & normalizing log/artifact CSVs."""
...
RULES = [
    ("TIM-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("TIM-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("TIM-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
