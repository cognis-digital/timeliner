#!/usr/bin/env sh
# Universal installer for timeliner. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/timeliner.git"
echo "Installing timeliner ..."
